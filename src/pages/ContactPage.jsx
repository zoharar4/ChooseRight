                ...
                <div className="contact-grid container">
                    ...
                    <div className="contact-info">
                        ...
                        <div className="contact-items">
                            <a href="mailto:shimritben1@gmail.com" className="contact-item" onClick={e => e.stopPropagation()}>
                                ...
                                <div>
                                    ...
                                    <span className="contact-item-value">shimritben1@gmail.com</span>
                                </div>
                            </a>

                            <a href="tel:+972545881616" className="contact-item">
                                ...
                                <div>
                                    ...
                                    <span className="contact-item-value">054-588-1616</span>
                                </div>
                            </a>

                            <a href="https://wa.me/9720545881616" target="_blank" rel="noreferrer" className="contact-item">
                        ...
                        <div className="contact-social-row">
                            <a
                                href="https://facebook.com/lbhwr.nkwn.smryt.bn.my"
                                target="_blank"
                                rel="noreferrer"
                            ...
                            >
                                ...
                                <div className="social-link-info">
                                    ...
                                    <span className="social-link-handle">@chooseright</span>
                                </div>
                            </a>
                        </div>
                    </div>
